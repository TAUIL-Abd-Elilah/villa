...
@click.option('--scale-segmentation', type=float, default=None, help='Segmentation-coordinate scale passed to vc_render_tifxyz')
@click.option('--slice-step', type=float, default=None, help='Distance between rendered slices')
@click.option('--cache-gb', type=click.IntRange(min=0), default=None, help='Remote chunk-cache size in GiB')
